...
% text message is 1024 char message burst
% text message signal will contain a chirp, and 1024 char
...
numchar = 1024;  % limit text message to 1024 char, one char = 8bits
...
%         if plotdebug == 1
%             figure(56)
%             set(56,'Position',[1000,50,1080,720]);
%             whitebg(56,'k');
%             plot(abs(xdet))
