...
% 
% message = 10^(-30/20)*message + noise;
message = [real(message)' imag(message)'];

[filename, pathname] = uiputfile('*.wav','Save I/Q WAVE File','c:\8LFM\8LFM12khz.wav');

pathname = [pathname filename];
audiowrite(pathname,message,fs);
